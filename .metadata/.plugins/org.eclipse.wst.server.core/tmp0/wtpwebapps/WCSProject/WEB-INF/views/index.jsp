	...
	<div class="row" >
		...
		<div class="col-lg-1">
			<div class="nav navbar-nav navbar-right">
                    <a href="ProductCategary"> Product Categary</a>
 		 ...
 		 <div class="nav navbar-nav navbar-center">
                    <a href="login"><span class="glyphicon 
                    glyphicon-log-in"></span> Login</a>
                    <a href="registration"><span class="glyphicon 
...
<div class="container">
 ...
 <!--  <p>The .thumbnail class can be used to display an image gallery.</p>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="DressProductDetails" target="_blank">
    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="NeckProductDetails" target="_blank">
